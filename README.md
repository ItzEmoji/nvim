...
📖 **Documentation** — a generated reference of every option this configuration sets,
built with Docusaurus from `docs/`. Not deployed yet; a hosted link will replace this
note once the site is live.
