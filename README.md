...
📖 **Documentation** — a generated reference of every keybinding this configuration
sets, plus guides to how it is built, using Docusaurus from `docs/`. Not deployed yet;
a hosted link will replace this note once the site is live.
